...
public class playerControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.X))
        {
            ...
            {
                NonPlayerCharacters character =
hit.collider.GetComponent<NonPlayerCharacters>();
                if (character != null)
                {
...
presentN);
        UI.instance.SetValue(currentHealth /
        (float)presentN);
    }
